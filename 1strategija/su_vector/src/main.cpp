...
int main() {
    ...
    int x;
    cout << "Spauskite 1, jei norite nuskaityti duomenis is failo ir atlikti veiksmus. Spauskite 2, jei norite ivesti duomenis. Spauskite 3, jei norite nuskaityti faila ir isspausdinti duomenis ekrane" << endl;
    cin >> x;
